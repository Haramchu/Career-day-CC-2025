...
const SessionPage = () => {
  ...
  const handleConfirm = async () => {
    ...
    if (currentCount >= eventData.event_lokasi_kapasitas) {
      alert('This talk is full. Please choose another.');
      return;
    }
        ...
        {confirmOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">Are you sure you want to enroll in this talk?</p>
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm bg-yellow-500 rounded hover:bg-yellow-600 text-black font-semibold"
                >
                  Confirm
                </button>
              </div>
